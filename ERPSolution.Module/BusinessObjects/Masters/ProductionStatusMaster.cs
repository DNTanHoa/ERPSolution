...
{
    [XafDisplayName("Tình Trạng Sản Xuất")]
    [XafDefaultProperty(nameof(name))]
    [Persistent(@"ProductionStatusMaster")]
    [DefaultClassOptions]
    public class ProductionStatusMaster : BaseObject
    {
        public ProductionStatusMaster(Session session) : base(session) { }
