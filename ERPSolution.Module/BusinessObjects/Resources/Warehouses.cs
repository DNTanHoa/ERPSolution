...
{
    [XafDisplayName("Nhà Kho")]
    [XafDefaultProperty(nameof(name))]
    [Persistent(@"WareHouses")]
    [DefaultClassOptions]
    public class Warehouses : BaseObject
    {
        ...
        private Employees _supporter;
        [XafDisplayName("Phụ Trách")]
        public Employees supporter
        {
            get => _supporter;
            set => SetPropertyValue(nameof(supporter), ref _supporter, value);
        }
